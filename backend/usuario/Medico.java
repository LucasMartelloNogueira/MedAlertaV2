...
public class Medico extends Pessoa {
    ...
    public static Medico resgatarMedicoArquivo(String emailMedico, String senhaFornecida, boolean ignorarSenha){
        try{
            ...
            while (linha != null){
                ...
                if (email.equals(emailMedico) && (ignorarSenha == true || senhaFornecida.equals(senha))){
